...
const MOCK_DATA: Record<string, Omit<AnalysisResult, 'timestamp'>> = {
  ...
  '현장용 선풍기': {
    ...
    bases: [{ title: '폭염 대비 근로자 건강장해 예방 조치 관련 질의회시', content: '옥외 작업장에서 근로자의 열사병 등 예방을 위해 설치하는 현장 작업용 선풍기, 이동식 에어컨 등은 건강장해예방비 항목으로 계상 가능함. 단, 현장 사무실 또는 고정식 휴게실 내 냉난방 장치는 불가.', source: '고용노동부 질의회시' }]
  },
  '쿨스카프': {
    itemName: '쿨스카프', category: '6. 근로자의 건강장해예방비 등', status: '△', statusLabel: '조건부 가능',
    summary: '쿨스카프, 쿨토시 등은 폭염 기간(6~9월) 동안 한시적으로 계상이 가능합니다.',
    bases: [{ title: '혹서기 폭염 대비 근로자 건강재해예방 기준', content: '6~9월 폭염 기간 동안 근로자에게 지급하는 쿨스카프, 쿨토시, 아이스조끼 등은 계상 가능함.', source: '고용노동부 지침' }]
  },
  '여름용 쿨스카프': {
    ...
    bases: [{ title: '혹서기 폭염 대비 근로자 건강재해예방 기준', content: '6월에서 9월 사이 폭염 기간 동안 근로자에게 지급하는 쿨스카프, 쿨토시, 멀티스카프, 아이스조끼 등은 계상 가능함.', source: '고용노동부 지침' }]
  },
  '회식비': {
    itemName: '회식비', category: '계상 불가 (복리후생 항목)', status: 'X', statusLabel: '계상 불가',
    summary: '회식비는 근로자 복리후생 성격의 비용으로 산업안전보건비로 계상할 수 없습니다.',
    bases: [{ title: '건설업 산업안전보건비 계상 및 사용기준 관련 질의회시', content: '회식비, 격려금, 간식비 등 근로자 복리후생 목적의 지출은 안전보건비 계상 대상에서 제외.', source: '고용노동부 지침' }]
  },
  '사무용품': {
    ...
    bases: [{ title: '건설업 산업안전보건비 계상 및 사용기준 관련 질의회시', content: '사무용 비품, 일반 소모품 등 공사수행 목적의 사무용품은 안전보건비 계상 대상 제외.', source: '고용노동부 지침' }]
  }
};
...
export async function analyzeItem(query: string): Promise<AnalysisResult> {
  ...
  if (isMockMode) {
    ...
    if (isX) {
      ...
      summary = `입력하신 '${query}' 항목은 사용 목적 및 장소에 따라 계상 가능 여부가 달라집니다. 옥외 작업 현장에서 근로자 건강장해 예방을 위해 사용하는 경우에 한해 인정될 수 있으며, 사무실·휴게실 등 일반 용도는 제외됩니다.`;
      content = `해당 물품은 사용 목적과 장소에 따라 계상 여부가 달라지므로, 구매 영수증 및 현장 배부 대장 등 증빙서류를 철저히 갖추어야 합니다.`;
      source = '고용노동부 질의회시';
      ...
      category =
        /인건비|관리자|보건관리|안전담당/.test(query)
          ...
          ? '4. 사업장의 안전진단비 등'
          : /시설|난간|소화|발판|통로|비계|방지망|표지|울타리|방책/.test(query)
          ? '2. 안전시설비 등'
          : '3. 개인보호구 및 소모품비 등';
      summary = `입력하신 '${query}' 항목은 산업재해 예방을 목적으로 하는 안전보건 관련 품목으로, 건설업 산업안전보건비 계상 및 사용기준 제7조에 따라 계상이 가능합니다.`;
      content = `해당 물품 또는 활동은 산업재해 예방을 직접적인 목적으로 하며, 고용노동부 고시 제7조 해당 항목에 부합합니다.`;
      source = '고용노동부 고시';
      ...
      summary = `입력하신 '${query}' 항목은 산업안전보건비 계상 기준에 부합하는 키워드가 확인되지 않아 계상이 불가합니다. 오타가 없는지 확인해 주세요.`;
      content = `산업안전보건비로 계상하기 위해서는 관련 법령(고시 제7조)의 사용 가능 항목에 부합해야 합니다. 키워드 매칭이 되지 않는 일반 소모품 등은 계상 대상에서 제외됩니다.`;
      source = '고용노동부 고시 기준';
    }
